...
class TarjetaController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $usuario = Tarjeta::where('email', $credenciales['email'])->first();
    ...
    {
        $exis = Tarjeta::with('Tarjetas','carreras')->find($id);
        if ($exis) {
