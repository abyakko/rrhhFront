...
class UniinsController extends Controller
{
    /**
    ...
    public function login(Request $request)
    {
        ...
        $usuario = Uni_ins::where('email', $credenciales['email'])->first();
    ...
    {
        $exis = Uni_ins::with('Uni_inss','carreras')->find($id);
        if ($exis) {
    ...
    public function update(Request $request, string $id)
    {
        ...
        $exis->Uni_ins_id = $request->Uni_ins_id;
