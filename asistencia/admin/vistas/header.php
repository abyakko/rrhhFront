...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>FACEBOL</b> SRL</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>FACEBOL</b> SRL</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Sistema de Control de Asistencia</small>
                </p>
              </li>
              <!-- Menu Footer-->
...
-->
<?php if ($_SESSION['tipousuario']=='ADMINISTRADOR' || $_SESSION['tipousuario']=='Encargado de Ventas') {
?>
      <li class="treeview">
          <a href="#">
          ...
          <?php if ($_SESSION['tipousuario']=='Encargado de Ventas') {
          ?>
            <ul class="treeview-menu">
