...
@section('content')
    ...
    <div class="card-body">
        ...
        <div class="float-ring">   
            @include('campana.create')
        </div>
        <br/>
    <table id="campana" class="table table-striped">
    <thead align="center">
        
        <th ><center>ID CAMPAÑA</center></th>
        <th><center>NOMBRE CAMPAÑA</center></th>
        <th><center>ACCIONES</center></th>
        

    </thead>
    <tbody align="center">
        @foreach ($campana as $Cam)
        <tr>
            <td>{{$Cam->id}}</td>
            <td>{{$Cam->nombre_campana}}</td>
            <td>
                @include('campana.edit', [$Cam->id])
            </td>
        </tr>
        @endforeach
        </tbody>
