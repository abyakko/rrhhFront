<a class="btn btn-primary" data-toggle="modal" data-target="#editModal{{$user->id}}" href="{{route('user.edit', $user)}}"><i class="fa fa-pen"> </i></a> 
    ...
    <div class="modal-dialog"> 
      <div class="modal-content">
        ...
        <div class="modal-body">
            {!! Form::model($user,['route'=> ['user.update', $user], 'method'=>'put', 'class'=>'editar']) !!}
